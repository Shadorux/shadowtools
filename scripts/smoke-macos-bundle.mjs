...
const app = process.argv[3]
  ...
  : path.join(releaseDir, unpackedDir, 'ShadowTools.app');
...
const expectedPlist = {
  ...
  NSScreenCaptureUsageDescription:
    'ShadowTools captures a display or window only when the enabled Desktop connector asks to observe it.'
};
...
const mainExecutable = path.join(contents, 'MacOS', 'ShadowTools');
