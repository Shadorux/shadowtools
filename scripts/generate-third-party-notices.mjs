...
const notices = [
  'ShadowTools — Third-party Notices',
  '',
  'ShadowTools remains MIT licensed; see LICENSE. This inventory preserves the license and notice texts',
  ...
  '',
  'Catalog artwork: Copyright (c) 2026 ShadowTools contributors. MIT licensed, see LICENSE.',
  ...
  'are not bundled with ShadowTools; their package directories retain their own licenses and notices.',
  ''
];
const missing = [];
notices.push('='.repeat(80), 'OpenAI Codex — adapted coding instructions and update_plan contract',
  ...
  'ShadowTools adapts identity and available tools, removes Codex-specific facilities and adds bounded plan details and session storage.', '');
...
notices.push('='.repeat(80), 'Optional plugin catalog — separate installations and hosted services', 'Reviewed package licenses and hosted-service references follow. External server code is not bundled with ShadowTools; custom installations and updates retain their own notices.', '');
