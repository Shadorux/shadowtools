...
the text incorporated by LGPLv3; it does not relicense ShadowTools as GPL software.
...
places `ShadowTools-Native-Sources.tar.gz` beside the matching installers at:
https://github.com/Shadorux/shadowtools/releases
